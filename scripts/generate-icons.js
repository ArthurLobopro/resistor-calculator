...
async function generateIcons() {
    const assets_path = path.resolve(__dirname, "../assets/icons/")
    const icons_out = path.resolve(__dirname, "../src/ui/components/all-icons")
    const icon_exporter_path = path.resolve(__dirname, "../src/ui/components/icons.tsx")
